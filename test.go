...
var (
	baseUrl        = "http://shipped-tx3-control-01.tx3.shipped-cisco.com/marathon/v2/"
	taskApi        = "tasks"
	applicationApi = "apps"
	user           = "synthetic-mon"
...
func main() {
	...
	auth := gomarathon.HttpBasicAuth{user,pwd}
 	 c, err := gomarathon.NewClient(baseUrl,&auth, nil)
    if err != nil {
